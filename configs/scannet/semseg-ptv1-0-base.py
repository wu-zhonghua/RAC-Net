...
data = dict(
    ...
    train=dict(
        ...
        transform_end=[
            dict(type="ToTensor"),
            dict(type="Collect", keys=("coord", "label"), feat_keys=("coord", "normal", "color"), coord_pointwolf_keys=(["coord_pointwolf"]), 
                 feat_pointwolf_keys=("coord_pointwolf", "normal", "color"), coord_at_keys=(["coord_at"]), 
                 feat_at_keys=("coord_at", "normal", "color"))
        ],
        test_mode=False,
    ),
